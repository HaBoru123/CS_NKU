...
#line 30 "test1.y"
                           { printf("%f\n", yyvsp[-1]); }
#line 1143 "test1.tab.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 35 "test1.y"
                          { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1149 "test1.tab.c"
    break;

  case 6: /* expr: expr SUB expr  */
#line 36 "test1.y"
                          { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1155 "test1.tab.c"
    break;

  case 7: /* expr: expr MUL expr  */
#line 37 "test1.y"
                          { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1161 "test1.tab.c"
    break;

  case 8: /* expr: expr DIV expr  */
#line 38 "test1.y"
                          { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1167 "test1.tab.c"
    break;
...
#line 40 "test1.y"
                                  { yyval =-yyvsp[0]; }
#line 1179 "test1.tab.c"
    break;

  case 11: /* expr: NUMBER  */
#line 41 "test1.y"
                   {yyval=yyvsp[0];}
#line 1185 "test1.tab.c"
    break;


#line 1189 "test1.tab.c"
